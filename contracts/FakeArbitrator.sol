...
contract SimpleCentralizedArbitrator is IArbitrator {
    ...
    function getNumberOfDisputes() public view returns (uint256) {
    ...
    function getDisputeData(uint256 _disputeID) public view returns (IArbitrable, uint256, uint256, DisputeStatus) {
        return (disputes[_disputeID].arbitrated,disputes[_disputeID].choices,disputes[_disputeID].ruling,disputes[_disputeID].status);
    }
